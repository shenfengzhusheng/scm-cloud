...
public class JobWeb {
    private static Logger logger = LoggerFactory.getLogger(JobWeb.class);
    ...
    public void addJob(String jobClassName, String jobGroupName, String cronExpression) throws Exception {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("job debug");
        }
        // 构建job信息
        JobDetail jobDetail = JobBuilder.newJob(this.getClass(jobClassName).getClass())
